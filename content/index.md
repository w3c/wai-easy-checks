...
<img role="img" src="{{ "/content-images/icon-alt-text.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-page-title.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-heading-structure.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-color-contrast.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-skip-link.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-keyboard-focus.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-page-language.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-zoom-levels.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-captions.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-transcripts.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-description.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-form-labels.svg" | relative_url }}" alt="" class="splash" />
...
<img role="img" src="{{ "/content-images/icon-required.svg" | relative_url }}" alt="" class="splash" />
