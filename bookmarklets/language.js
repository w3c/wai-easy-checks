...
document.querySelector('body').insertAdjacentHTML('afterbegin','<aside id="wai-info-box" tabindex="-1"><header>Page Language<a href="javascript:document.querySelectorAll(\"#wai-styles,#wai-info-box\").forEach(el=>{el.remove()})" aria-label="dismiss">X</a></header><div>' + message + '<p>Find out more about <a href="https://www.w3.org/wai/easy-checks/language/">Checking Page Language</a></div></aside>');
